...
| image.repository | string | `"springboot-s3"` |  |
...
| serviceAccount.annotations | object | `{"eks.amazonaws.com/role-arn":"arn:aws:iam::183631338639:role/krci-cmtr-f9iioa28-assume-role"}` | Annotations to add to the service account |
